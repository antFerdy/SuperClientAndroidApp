                        ...
                        public void onClick(View v) {
                            if (mClickable) {
                                if (halfstart) {
                                    ...
                                    Log.i("time 1",String.valueOf(System.currentTimeMillis()));
                                    setStar(indexOfChild(v) + 1f);
                                    Log.i("time 2",String.valueOf(System.currentTimeMillis()));
                                    if (onRatingChangeListener != null) {
                                        Log.i("time 3",String.valueOf(System.currentTimeMillis()));
                                        onRatingChangeListener.onRatingChange(indexOfChild(v) + 1f);
                                        Log.i("time 4",String.valueOf(System.currentTimeMillis()));
                                    }
                                }
